...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // 登録した本人にしか見えない・選べない。
        if (!Schema::hasTable('user_artists')) {
        ...
        if (!Schema::hasTable('user_concerts')) {
        ...
        if (!Schema::hasTable('user_setlists')) {
        ...
        // どちらか一方だけを参照する。
        if (!Schema::hasColumn('external_user_attendances', 'user_setlist_id')) {
