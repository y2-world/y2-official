...
use App\Filament\Resources\OfficialNewsResource\Pages;
use App\Filament\Resources\OfficialNewsResource\RelationManagers;
...
class OfficialNewsResource extends Resource
{
    protected static ?string $model = OfficialNews::class;
    ...
    {
        return [
            'index' => Pages\ListOfficialNews::route('/'),
            'create' => Pages\CreateOfficialNews::route('/create'),
            'edit' => Pages\EditOfficialNews::route('/{record}/edit'),
        ];
    }
}
