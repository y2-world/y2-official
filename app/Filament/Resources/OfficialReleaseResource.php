...
use App\Filament\Resources\OfficialReleaseResource\Pages;
use App\Filament\Resources\OfficialReleaseResource\RelationManagers;
...
class OfficialReleaseResource extends Resource
{
    protected static ?string $model = OfficialRelease::class;
                ...
                Forms\Components\Repeater::make('tracklist')
                    ...
                    ->schema([
                        ...
                        Forms\Components\Select::make('id')
                            ->label('曲名')
                            ->options(fn() => \App\Models\OfficialLyric::pluck('title', 'id'))
                            ->searchable()
                            ->native(false)
                            ->columnSpanFull(),
    ...
    {
        return [
            'index' => Pages\ListOfficialReleases::route('/'),
            'create' => Pages\CreateOfficialRelease::route('/create'),
            'edit' => Pages\EditOfficialRelease::route('/{record}/edit'),
        ];
    }
}
