<div x-data="{
    ...
    <div
        ...
        x-transition
        style="position: absolute; top: 100%; left: 0; width: auto; min-width: 300px; background: white; border: 1px solid #ddd; border-radius: 4px; margin-top: 4px; max-height: 300px; overflow-y: auto; z-index: 1000; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        <template x-for="(song, index) in songs" :key="song.id">
            <div
                @click="selectSong(song.id)"
                :class="{ 'bg-gray-100': index === selectedIndex }"
                style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid #eee; color: black; text-align: left; font-size: 14px;"
