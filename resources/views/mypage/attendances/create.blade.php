        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div style="margin-top: 24px; text-align: center;">
                    ...
                    <form id="newArtistForm" method="POST" action="{{ route('mypage.attendances.artists.new') }}" @if(!$errors->any()) hidden @endif style="max-width: 360px; margin: 16px auto 0;">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div style="text-align: center; margin-top: 8px;">
                            <button type="button" onclick="document.getElementById('newArtistForm').hidden = true; document.getElementById('newArtistToggle').hidden = false;" style="background: none; border: none; color: #999; cursor: pointer; padding: 8px;" title="閉じる">
