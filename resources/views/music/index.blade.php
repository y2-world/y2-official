        ...
        <div class="container-lg">
            ...
            <div class="col-md-12">
                ...
                <ul class="music-menu">
                    ...
                    <li><a href="{{ url('/music?type=1') }}" class="{{ request('type') == '1' ? 'active' : '' }}">Single</a>
                    </li>
                    <li><a href="{{ url('/music?type=2') }}" class="{{ request('type') == '2' ? 'active' : '' }}">Album</a>
                    </li>
                </ul>
                        ...
                        <div class="album-wrapper">
                            @foreach ($discos as $disc)
                                <div class="single">
                                    ...
                                    <p class="topic">{{ $disc->subtitle }}<br>{{ date('Y.m.d', strtotime($disc->date)) }}
                                    </p>
                                </div>
                            @endforeach
                        </div>
