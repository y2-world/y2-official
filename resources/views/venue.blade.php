...
@section('content')
    <div class="database-hero database-hero--detail">
        <div class="container" style="position: relative;">
            ...
            <p class="database-subtitle sp" style="">会場検索結果</p>
            <p class="database-subtitle pc" style="">会場検索結果</p>
            <h1 class="database-title sp" style="cursor: pointer;" onclick="document.getElementById('spSearchFormVenue').style.display='block'; this.style.display='none'; document.querySelectorAll('.database-subtitle.sp').forEach(el => el.style.display='none');">{{ $keyword }}</h1>
            <h1 class="database-title pc" style="">{{ $keyword }}</h1>

            @if ($data->isEmpty())
                <p class="database-subtitle sp" style="">検索結果がありません</p>
                <p class="database-subtitle pc" style="">検索結果がありません</p>
            @else
                <p class="database-subtitle sp" style="">全{{ count($data) }}件</p>
                <p class="database-subtitle pc" style="">全{{ count($data) }}件</p>
            @endif
