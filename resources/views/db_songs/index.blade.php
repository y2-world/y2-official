        ...
        <div class="container" style="position: relative;">
            ...
            <div class="setlists-header-row">
                <div style="flex-shrink: 0;">
                    <h1 class="database-title" style="white-space: nowrap;">Songs</h1>
                    <p class="database-subtitle" style="margin: 4px 0 0;">{{ $artist->name }} — すべての楽曲コレクション</p>
                </div>
                <div class="header-selects" style="display: flex; align-items: center; gap: 10px; flex-wrap: nowrap; overflow-x: auto; max-width: 100%;">
                    ...
                    <select class="year-select" name="select" onChange="location.href=value;">
                        ...
                        <option value="{{ route('database.songs', $artist->id) }}" selected>Songs</option>
            ...
            {{-- 検索フォーム（SP表示） --}}
            <div class="sp" id="spSearchFormSongs" style="margin-top: 15px; display: none;">
                @livewire('database-song-search', ['artistId' => $artist->id])
            </div>
        </div>
    </div>
